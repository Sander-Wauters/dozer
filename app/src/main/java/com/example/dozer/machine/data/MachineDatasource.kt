...
class MachineDatasource {
    ...
    fun loadMachines(): List<MachineDto.Index> {
        return listOf(
            MachineDto.Index(0, "Liebherr", "Compact Litronic", "A 910", "Excavator", description, "https://assets-cdn.liebherr.com/assets/api/0fc09691-4282-417b-85b5-cd90b8896f33/w-320_h-320_f-webp/"),
            MachineDto.Index(0, "Liebherr", "Litronic", "A 914", "Excavator", description, "https://assets-cdn.liebherr.com/assets/api/33685b56-dc2c-45b3-990a-5321c14f2eda/w-320_h-320_f-webp/"),
            MachineDto.Index(0, "Liebherr", "Heavy Lift Litronic", "A 924", "Excavator", description, "https://assets-cdn.liebherr.com/assets/api/6bf6f3b4-3c1d-4e04-9fa8-ce170f518451/w-320_h-320_f-webp/"),
